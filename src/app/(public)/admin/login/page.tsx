...
export default function AdminLoginPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const response = await apiService.login({ email: formData.username, password: formData.password });
            ...
            if (response.token) {
                ...
                // O useEffect vai redirecionar automaticamente quando isAuthenticated mudar
            } else {
